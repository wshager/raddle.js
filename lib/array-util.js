...
function foldLeft(...$_a) {
	...
	if ($_l == 3) {
		...
		return n.item($.test(n.eq(array.size($.get("array")), n.integer(0))) ? $.get("zero") : foldLeft(array.tail($.get("array")), n.call($.get("function"), $.get("zero"), array.head($.get("array"))), $.get("function")));
	}
...
function foldLeftAt(...$_a) {
	...
	if ($_l == 4) {
		...
		return n.item($.test(n.eq(array.size($.get("array")), n.integer(0))) ? $.get("zero") : foldLeftAt(array.tail($.get("array")), n.call($.get("function"), $.get("zero"), array.head($.get("array")), $.get("at")), $.get("function"), n.add($.get("at"), n.integer(1))));
	}
...
function foldRightAt(...$_a) {
	...
	if ($_l == 4) {
		$.init($.array("array"), $.item("zero"), $.item("function"), $.item("at"));
		return n.item($.test(n.eq(array.size($.get("array")), n.integer(0))) ? $.get("zero") : n.call($.get("function"), array.head($.get("array")), foldRightAt(array.tail($.get("array")), $.get("zero"), $.get("function"), n.add($.get("at"), n.integer(1)))));
	}
...
function forEach(...$_a) {
	...
	if ($_l == 3) {
		...
		return n.item($.test(n.eq(array.size($.get("array")), n.integer(0))) ? $.get("ret") : forEach(array.tail($.get("array")), $.get("function"), array.append($.get("ret"), n.call($.get("function"), array.head($.get("array"))))));
	}
...
function forEachAt(...$_a) {
	...
	if ($_l == 4) {
		...
		return n.item($.test(n.eq(array.size($.get("array")), n.integer(0))) ? $.get("ret") : forEachAt(array.tail($.get("array")), $.get("function"), array.append($.get("ret"), n.call($.get("function"), array.head($.get("array")), $.get("at"))), n.add($.get("at"), n.integer(1))));
	}
