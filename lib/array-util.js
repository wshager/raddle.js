...
function put$3(...$_a) {
	var $ = n.frame($_a).array("array", $.item(n.zeroOrOne)).item("position").item("member");
	return array.insertBefore(array.remove($("array"), $("position")), $("position"), $("member"));
}

function foldLeft$3(...$_a) {
	var $ = n.frame($_a).array("array", $.item(n.zeroOrOne)).item("zero").item("function");
	return foldLeft($("array"), $("zero"), $("function"), array.size($("array")));
}

function foldLeft$4(...$_a) {
	var $ = n.frame($_a).array("array", $.item(n.zeroOrOne)).item("zero").item("function").item("s");
	return ($ => {
...
function foldLeftAt$4(...$_a) {
	var $ = n.frame($_a).array("array", $.item(n.zeroOrOne)).item("zero").item("function").item("at");
	return foldLeftAt($("array"), $("zero"), $("function"), $("at"), array.size($("array")));
}

function foldLeftAt$5(...$_a) {
	var $ = n.frame($_a).array("array", $.item(n.zeroOrOne)).item("zero").item("function").item("at").item("s");
	return ($ => {
		if ($.test(n.eq($("s"), n.integer(0)))) {
			return $("zero");
		} else {
...
function forEach$2(...$_a) {
	var $ = n.frame($_a).array("array", $.item(n.zeroOrOne)).item("function");
	return forEach($("array"), $("function"), n.array(n.seq()));
}

function forEach$3(...$_a) {
	var $ = n.frame($_a).array("array", $.item(n.zeroOrOne)).item("function").item("ret");
	return ($ => {
...
function forEachAt$4(...$_a) {
	var $ = n.frame($_a).array("array", $.item(n.zeroOrOne)).item("function").item("ret").item("at");
	return ($ => {
		if ($.test(n.eq(array.size($("array")), n.integer(0)))) {
			return $("ret");
		} else {
...
function last$1(...$_a) {
	var $ = n.frame($_a).array("array", $.item(n.zeroOrOne));
...
function firstIndexOf$2(...$_a) {
	var $ = n.frame($_a).array("array", $.item(n.zeroOrOne)).item("lookup", n.zeroOrOne);
