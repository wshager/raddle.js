...
exports.module = exports.autoConverted = exports.nativeOps = exports.typemap = exports.$module = exports.$uri = exports.$prefix = undefined;
...
exports.compositeType$1 = compositeType$1;
...
const $prefix = exports.$prefix = "core";

const $uri = exports.$uri = "http://raddle.org/javascript";

const $module = exports.$module = n.module(__filename);

const typemap = exports.typemap = n.map(n.seq(n.pair(n.string("boolean"), n.integer(0)), n.pair(n.string("integer"), n.integer(0)), n.pair(n.string("decimal"), n.integer(0)), n.pair(n.string("double"), n.integer(0)), n.pair(n.string("string"), n.integer(0)), n.pair(n.string("item"), n.integer(0)), n.pair(n.string("anyURI"), n.integer(0)), n.pair(n.string("map"), n.integer(2)), n.pair(n.string("function"), n.integer(1)), n.pair(n.string("array"), n.integer(1)), n.pair(n.string("element"), n.integer(0)), n.pair(n.string("attribute"), n.integer(0)), n.pair(n.string("numeric"), n.integer(0)), n.pair(n.string("atomic"), n.integer(0)), n.pair(n.string("document-node"), n.integer(0)), n.pair(n.string("node"), n.integer(0)), n.pair(n.string("QName"), n.integer(0))));
...
function processArgs$4(...$_a) {
    ...
    return ($ => {
        if ($.test(n.instanceOf($("frame"), n.string("")))) {
            ...
            $ = $("isDefn", n.geq($("caller"), n.seq(n.string("core:define-private#6"), n.string("core:define-private#5"), n.string("core:define#6"), n.string("core:define#5"))));
...
function interop$2(...$_a) {
    ...
    return ($ => {
        if ($.test(n.instanceOf($("arities"), n.string("")))) {
            ...
            $ = $("fname", rdl.camelCase(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), fn.last($_0)))));
...
function transpile$2(...$_a) {
    ...
    $ = $("distinct", array.foldLeft($("value"), n.map(n.seq()), function (...$_a) {
        ...
        return ($ => {
            if ($.test($.test(n.geq(n.call($("cur"), n.string("name")), n.seq(n.string("core:define"), n.string("core:define-private")))) && $.test(n.eq(array.size(n.call($("cur"), n.string("args"))), n.integer(6))))) {
                ...
                $ = $("arity", array.size($("args")));
                $ = $("last", n.call($("args"), $("arity")));
                $ = $("hasRestParam", ($ => {
                    if ($.test(n.instanceOf($("last"), n.map()))) {
                        return fn.matches(n.call(n.call($("last"), n.string("args")), n.integer(2)), n.string("^\\.{3}"));
                    } else {
                ...
                return ($ => {
                    if ($.test(map.contains($("pre"), $("name")))) {
                        return map.put($("pre"), $("name"), array.append(n.call($("pre"), $("name")), $("arity")));
                    } else {
                        ...
                        if ($.test(map.contains($("value"), n.string("$tree")))) {
                            ...
                            return ($ => {
                                if ($.test(fn.matches($("name"), n.concat(n.concat(n.string("^core:["), rdl.ncname), n.string("]+$"))))) {
                                    ...
                                    $ = $("isFn", $.test($.test(n.seq($.test($("isDefn")) && $.test(n.seq($.test(n.eq($("s"), n.integer(6))) || $.test(n.eq($("s"), n.integer(5))))))) || $.test(n.seq($.test(n.eq($("local"), n.string("anon"))) && $.test(n.eq($("s"), n.integer(4)))))) || $.test(n.seq(n.eq($("local"), n.string("interop")))));
                                    $ = $("letRet", ($ => {
                                    ...
                                    $ = $("n", ($ => {
                                        if ($.test(fn.empty($("fn")))) {
                                            return console.log(n.seq($("name"), n.string("#"), $("s"), n.string(":"), $("args")));
                                        } else {
                                            return n.seq();
                                        }
                                    })($.frame()));
                        ...
                        if ($.test(fn.matches($("string"), n.string("^(\\$.*)$|^([^#]+#[0-9]+)$")))) {
                            ...
                            return ($ => {
                                if ($.test(n.eq(fn.count($("parts")), n.integer(1)))) {
                                    ...
                                    return ($ => {
                                        if ($.test(fn.matches(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(1))), fn.concat(n.string("^\\$?"), n.call($("frame"), n.string("$prefix")))))) {
                                            return fn.replace(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), fn.last($_0))), n.string("\\$"), n.string(""));
                                        } else {
                                            return fn.concat(fn.replace(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(1))), n.string("\\$"), n.string("")), n.string("."), n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(2))));
                                        }
                                    })($.frame());
                                }
                            })($.frame());
...
function anonName$4(...$_a) {
    ...
    return ($ => {
        if ($.test(n.instanceOf($("frame"), n.string("")))) {
            ...
            $ = $("prefix", ($ => {
                if ($.test(n.eq(n.cxFilter($("p"), $_0 => n.geq(fn.position($_0), n.subtract(fn.last($_0), n.integer(1)))), $("prefix")))) {
                    return n.seq();
                } else {
                    return ($ => {
                        if ($.test(n.cxFilter($("p"), $_0 => n.geq(fn.position($_0), n.subtract(fn.last($_0), n.integer(1)))))) {
                            return n.cxFilter($("p"), $_0 => n.geq(fn.position($_0), n.subtract(fn.last($_0), n.integer(1))));
                        } else {
            ...
            })($.frame()), rdl.camelCase(n.cxFilter($("p"), $_0 => n.geq(fn.position($_0), fn.last($_0)))));
        }
    })($.frame());
}
...
function compositeType$1(...$_a) {
    var $ = n.frame($_a).item("composite");
    return ($ => {
        if ($.test(n.instanceOf($("composite"), n.string("")))) {
            return fn.concat(n.string("composite-type("), $("composite"), n.string(")"));
        } else {
            return fn.stringJoin(array.flatten(array.forEach($("composite"), function (...$_a) {
                $ = $.frame($_a).item("_");
                return ($ => {
                    if ($.test(n.instanceOf($("_"), n.string("")))) {
                        return cardinality(n.array(n.seq($("_"))));
                    } else {
                        return ($ => {
                            if ($.test(n.eq(n.call($("_"), n.string("name")), n.string("")))) {
                                return fn.concat(n.string("("), composite - type(n.call($("_"), n.string("args"))), n.string(")"));
                            } else {
                                return fn.concat(fn.replace(n.call($("_"), n.string("name")), n.string("core:"), n.string("\\$.")), n.string("("), cardinality(n.array(n.seq(n.call($("_"), n.string("suffix"))))), n.string(")"));
                            }
                        })($.frame());
                    }
                })($.frame());
...
function define$7(...$_a) {
    ...
    return ($ => {
        if ($.test(n.instanceOf($("frame"), n.string("")))) {
            ...
            $ = $("init", array.forEach($("args"), function (...$_a) {
                $ = $.frame($_a).item("_");
                return ($ => {
                    if ($.test(n.instanceOf($("_"), n.map()))) {
                        $ = $("args", n.call($("_"), n.string("args")));
                        $ = $("param", n.call($("args"), n.integer(2)));
                        $ = $("param", ($ => {
            ...
            return fn.concat(($ => {
                ...
                if ($.test(n.eq($("body"), n.string("")))) {
                    return fn.concat(n.string("return "), n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(1))), n.string("."), $("fname"), n.string(".apply(this,$_a);"));
                } else {
                    return $("body");
                }
...
function compositeType(...$_a) {
    var $_l = $_a.length;
    if ($_l === 1) {
        return compositeType$1.apply(this, $_a);
    }

    return n.error(compositeType, $_l);
}
