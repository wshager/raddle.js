...
class Context {
    ...
    item(k) {
        return this.let(k, _xvfn.item);
    }
    string(k) {
        return this.let(k, _xvfn.string);
    }
    integer(k) {
        return this.let(k, _xvfn.integer);
    }
    decimal(k) {
        return this.let(k, _xvfn.decimal);
    }
    double(k) {
        return this.let(k, _xvfn.double);
    }
    number(k) {
        return this.let(k, _xvfn.number);
    }
