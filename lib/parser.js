...
exports.parseString = exports.parse = undefined;
		...
		$tpls.subscribe({
			next(tpl) {
				...
				if (tpl.t === 0) {
					...
					(0, _richReducers.reduceAround)(expandBinOps(state.r), toL3, $o);
...
const parse = exports.parse = path => lex(tokenize(initTokenState(), (0, _nodeStream.fromReadStream)(path).pipe((0, _operators.mergeMap)(chunk => (0, _rxjs.from)(chunk.toString())), (0, _operators.concat)(EOF))));

const parseString = exports.parseString = str => lex(tokenize(initTokenState(), (0, _rxjs.from)(str + EOF)));