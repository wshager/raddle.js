...
const parse = exports.parse = path => (0, _nodeStream.fromReadStream)(path).pipe((0, _operators.mergeMap)(chunk => (0, _rxjs.from)(chunk.toString())), boundTokenize, lex);

const parseString = exports.parseString = str => (0, _rxjs.from)(str).pipe(boundTokenize, lex);