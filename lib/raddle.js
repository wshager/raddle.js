...
function parseStrings(...$_a) {
  ...
  if ($_l == 3) {
    ...
    return wrap(n.select(fn.analyzeString(n.call($.get("normalizer"), fn.stringJoin(fn.forEach(n.to(n.integer(1), fn.count($.get("strings"))), function (...$_a) {
      var $_l = $_a.length;
      $ = n.frame($, $_a);
      if ($_l == 1) {
        $.init($.item("i"));
      ...
      return n.error($_l);
    })), $.get("params")), parenRegexp), n.seq(n.string("fn:match"))), $.get("strings"));
  }
    ...
    return fn.forEach(n.to(n.integer(1), fn.count(fn.indexOf($.get("tok"), n.integer(1)))), function (...$_a) {
      ...
      if ($_l == 1) {
        ...
        return n.item($.test(n.and(fn.exists(n.filter(fn.indexOf($.get("tok"), n.minus(n.integer(1))), function ($_0) {
          ...
          return n.geq(fn.position($_0), $.get("i"));
        }))) ? n.seq() : n.add(n.filter(fn.indexOf($.get("tok"), n.integer(1)), function ($_0) {
          return n.geq(fn.position($_0), $.get("i"));
        }), n.integer(1)));
      }
      return n.error($_l);
...
function getIndex(...$_a) {
  ...
  if ($_l == 1) {
    ...
    return n.filter(getIndexFromTokens(fn.forEach($.get("rest"), function (...$_a) {
      ...
      if ($_l == 1) {
        $.init($.item("_"));
        return $.item("_", n.selectAttribute(n.filter(n.select($.get("_"), n.seq(n.string("fn:group"))), function ($_0) {
            //console.log($_0);
          return fn.exists(n.select($_0, $_ => n.text($_)));
      }), n.string("nr"))), n.item($.test(n.geq($.get("_"), n.integer(1))) ? n.integer(1) : $.test(n.geq($.get("_"), n.integer(4))) ? n.minus(n.integer(1)) : n.integer(0));
      }
      return n.error($_l);
    })), function ($_0) {
...
function appendOrNest(...$_a) {
  ...
  if ($_l == 5) {
    ...
    var has3 = n.filter($.get("group"), function ($_0) {
    ...
    n.map(
        n.seq(n.pair(n.string("name"),
            valueFromStrings(n.select(n.filter($.get("group"), function ($_0) {
              return n.geq(n.selectAttribute($_0, n.string("nr")), n.integer(3));
            }), function ($_0) {
              return fn.string($_0);
            }), $.get("strings"))),
            n.pair(n.string("args"), wrap($.get("next"), $.get("strings"))),
            n.pair(n.string("suffix"), $.get("suffix"))
        )
    ) :
    ...
    n.item($.test(fn.matches(n.select(n.filter($.get("group"), function ($_0) {
      ...
      return fn.string($_0);
    })), $.test(n.ggt(array.size($.get("ret")), n.integer(0))) ? ($.item("rev", array.reverse($.get("ret"))), $.item("last", array.head($.get("rev"))), $.item("ret", array.reverse(array.tail($.get("rev")))), $.item("op", xqc.opInt($.get("operator"))), $.test(fn.empty($.get("last"))) ? array.append($.get("ret"), n.map(n.seq(n.pair(n.string("name"), $.get("operator")), n.pair(n.string("args"), $.get("x")), n.pair(n.string("suffix"), n.string(""))))) : ($.item("hasPrecedingOp", n.and(n.instanceOf($.get("last"), n.map()), fn.matches(n.call($.get("last"), n.string("name")), xqc.operatorRegexp))), $.item("prevOp", $.test($.get("hasPrecedingOp")) ? xqc.opInt(n.call($.get("last"), n.string("name"))) : n.seq()), $.item("preceeds", n.and(n.and($.get("hasPrecedingOp"), n.ggt($.get("op"), $.get("prevOp"))), fn.not(n.and(n.eq($.get("op"), n.integer(20)), n.eq($.get("prevOp"), n.integer(19)))))), $.test($.get("preceeds")) ? ($.item("y", n.map(n.seq(n.pair(n.string("name"), $.get("operator")), n.pair(n.string("args"), n.array(n.seq(n.call($.get("last"), n.seq(n.string("args"))), n.seq(n.integer(2)), $.get("x")))), n.pair(n.string("suffix"), n.string(""))))), array.append($.get("ret"), n.map(n.seq(n.pair(n.string("name"), n.call($.get("last"), n.string("name"))), n.pair(n.string("args"), n.array(n.seq(n.call($.get("last"), n.seq(n.string("args"))), n.seq(n.integer(1)), $.get("y")))), n.pair(n.string("suffix"), n.string("")))))) : array.append($.get("ret"), n.map(n.seq(n.pair(n.string("name"), $.get("operator")), n.pair(n.string("args"), n.array(n.seq($.get("last"), $.get("x")))), n.pair(n.string("suffix"), n.string(""))))))) : array.append($.get("ret"), n.map(n.seq(n.pair(n.string("name"), $.get("operator")), n.pair(n.string("args"), $.get("x")), n.pair(n.string("suffix"), n.string("")))))) : array.append($.get("ret"), $.get("x")));
  }
...
function appendPropOrValue(...$_a) {
  ...
  if ($_l == 4) {
    ...
    var ret = n.item($.test(fn.matches($.get("operator"), n.concat(xqc.operatorRegexp, n.string("+")))) ? $.test(n.ggt(array.size($.get("ret")), n.integer(0))) ? xqc.operatorPrecedence($.test(fn.exists($.get("string"))) ? valueFromStrings($.get("string"), $.get("strings")) : n.seq(), $.get("operator"), $.get("ret")) : array.append($.get("ret"), n.map(n.seq(n.pair(n.string("name"), xqc.unaryOp($.get("operator"))), n.pair(n.string("args"), n.array(n.seq(valueFromStrings($.get("string"), $.get("strings"))))), n.pair(n.string("suffix"), n.string(""))))) : array.append($.get("ret"), valueFromStrings($.get("string"), $.get("strings"))));
    //console.log("apv",ret);
    return ret;
  }
...
function wrapOpenParen(...$_a) {
  ...
  if ($_l == 5) {
    ...
    var ret = n.item(wrap(fn.subsequence($.get("rest"), $.get("index")), $.get("strings"), appendOrNest(fn.subsequence($.get("rest"), n.integer(1), $.get("index")), $.get("strings"), $.get("group"), $.get("ret"), fn.replace(n.filter($.get("rest"), $ => n.seq(n.subtract($.get("index"), n.integer(1)))), n.string("\\)"), n.string("")))));
    return ret;
  }
...
function wrap(...$_a) {
  ...
  if ($_l == 4) {
    ...
    return $.test(fn.exists($.get("rest"))) ? $.test(n.filter($.get("group"), function ($_0) {
      return n.and(n.geq(n.selectAttribute($_0, n.string("nr")), n.integer(4)),n.text($_0));
  ...
  if ($_l == 3) {
    ...
    var ret = n.item(wrap(fn.tail($.get("match")), $.get("strings"), $.get("ret"), n.select(fn.head($.get("match")), n.seq(n.string("fn:group")))));
    return ret;
  }
  if ($_l == 2) {
    $.init($.item("match"), $.item("strings"));
    var ret = wrap($.get("match"), $.get("strings"), n.array(n.seq()));
    //console.log("ret",ret);
...
function stringify(...$_a) {
  ...
  if ($_l == 3) {
    ...
    return $.item("s", array.size($.get("a"))), a.foldLeftAt($.get("a"), n.string(""), function (...$_a) {
      var $_l = $_a.length;
      $ = n.frame($, $_a);
      if ($_l == 3) {
...
function exec(...$_a) {
  ...
  if ($_l == 2) {
    $.init($.item("query"), $.item("params"));
    return $.item("core", n.import(n.string("../lib/core.xql"))), $.item("n", n.import(n.string("../lib/n.xql"))), n.item($.test(map.contains($.get("params"), n.string("$transpile"))) ? $.test(n.eq(n.call($.get("params"), n.string("$transpile")), n.string("rdl"))) ? stringify(parse($.get("query"), $.get("params")), $.get("params")) : transpile(parse($.get("query"), $.get("params")), n.call($.get("params"), n.string("$transpile")), $.get("params")) : ($.item("frame", map.put($.get("params"), n.string("$imports"), n.map(n.seq(n.pair(n.string("core"), $.get("core")), n.pair(n.string("n"), $.get("n")))))), n.eval(parse($.get("query"), $.get("params"))), $.get("frame")));
  }
