...
export function normalizeQuery() {
    ...
    return n.initialize(arguments, [
        ...
        return ($=n.put($, "query", n.item(fn.replace(fn.replace(fn.replace(fn.replace(n.fetch($, "query"), n.string("%3E"), n.string(">")), n.string("%3C"), n.string("<")), n.string("%2C"), n.string(",")), n.string("%3A"), n.string(":")))),
            ...
            $=n.put($, "query", n.item(fn.foldLeft(n.filter(n.sort(map.keys(operators)), function($_0) {
            ...
            $=n.put($, "query", n.item(block(n.filter(n.select(fn.analyzeString(n.fetch($, "query"), n.string("([^\\s\\(\\),\\.;]+)")), n.seq(n.string("*"))), function($_0) {
                //console.log(fn.string($_0), n.or(n.geq(fn.name($_0), n.string("fn:match")), n.geq(fn.matches(fn.string($_0), n.string("^\\s*$")), fn.false())));
        ...
        return ($=n.put($, "head", n.item(n.select(n.filter(n.select(fn.head(n.fetch($, "parts")), n.seq(n.string("fn:group"))), function($_0) {
            ...
            n.iff($, n.eq(n.fetch($, "maybeSeqtype"), n.decimal(20.06)),
                ...
                function($) {
                    ...
                    return n.stop($, n.item(body(n.fetch($, "parts"), fn.concat(n.fetch($, "ret"), n.string(",")), n.seq(n.fetch($, "lastseen"), n.decimal(21.06)))));
                                ...
                                function($) {
                                    ...
                                    return n.iff($, n.fetch($, "subtype"),
                                        ...
                                        function($) {
                                            ...
                                            return n.stop($, n.item(params(fn.tail(n.fetch($, "parts")), fn.concat(n.fetch($, "ret"), n.string(",")), n.seq())));
                                        ...
                                        function($) {
                                            ...
                                            return n.iff($, fn.matches(n.fetch($, "next"), n.string("^\\s*\\(\\s*$")),
                                                ...
                                                function($) {
                                                    ...
                                                    return n.cont($, fn.subsequence(n.fetch($, "parts"), n.integer(3)), fn.concat(n.fetch($, "ret"), n.fetch($, "head"), n.string("("), n.fetch($, "param"), n.string(","), n.iff($, n.eq(n.fetch($, "head"), n.string("core:function")),
                                                ...
                                                function($) {
                                                    ...
                                                    return n.cont($, fn.tail(n.fetch($, "parts")), fn.concat(n.fetch($, "ret"), n.fetch($, "head"), n.string("("), n.fetch($, "param"), n.iff($, n.eq(n.fetch($, "head"), n.string("core:function")),
                                                                ...
                                                                function($) {
                                                                    ...
                                                                    return n.iff($, n.eq(n.fetch($, "non"), n.integer(24)),
                                                                        ...
                                                                        function($) {
                                                                            ...
                                                                            return n.cont($, fn.tail(n.fetch($, "parts")), fn.concat(n.fetch($, "ret"), n.iff($, n.fetch($, "subtype"),
                ...
                function($) {
                    ...
                    return n.stop($, n.item(n.iff($, n.eq(n.fetch($, "next"), n.string("=#24=")),
                        ...
                        function($) {
                            ...
                            return as(n.seq(), fn.tail(n.fetch($, "parts")), fn.concat(n.fetch($, "ret"), n.string(")")), n.fetch($, "lastseen"), fn.false(), fn.false());
            ...
            function($) {
                ...
                return n.iff($, n.ne(fn.head(n.fetch($, "lastseen")), n.decimal(0.01)),
                    ...
                    function($) {
                        ...
                        return n.cont($, fn.tail(n.fetch($, "lastseen")), n.fetch($, "no"), fn.head(n.fetch($, "lastseen")),
                                    ...
                                    return n.iff($, n.eq(fn.round(n.fetch($, "no")), n.integer(21)),
                                        ...
                                        function($) {
                                            ...
                                            return $=n.put($, "old", n.item(n.fetch($, "lastseen"))),
                                                ...
                                                $=n.put($, "positional", n.item(n.and(n.and(n.and(n.eq(n.fetch($, "no"), n.decimal(20.01)), n.fetch($, "next")),
                                                    fn.matches(n.fetch($, "next"), n.concat(n.concat(n.string("^([\\+\\-]?(\\p{N}+))$|^\\$["), ncname), n.string("]+$")))), n.eq(n.filter(n.fetch($, "rest"), function($_0) {
                                                    return n.geq(fn.position($_0), n.integer(2));
                                                }), n.string("=#20#02="))))),
                                                        ...
                                                        return n.iff($, n.or(fn.empty(n.fetch($, "rest")), fn.not(n.geq(n.fetch($, "no"), n.seq(n.decimal(2.09), n.decimal(20.01))))),
                                                            ...
                                                            function($) {
                                                                ...
                                                                return n.iff($, n.and(n.geq(n.fetch($, "next"), fns), fn.matches(n.filter(n.fetch($, "rest"), function($_0) {
                                                                    ...
                                                                    function($) {
console.log(n.string("bodyop rest from fns"))
                                                                    ...
                                                                    function($) {
console.log(n.string("bodyop rest otherwise"))
                                                                        return fn.tail(n.fetch($, "rest"));
...
console.log(n.string("call body3 from op")),
                                                body(n.fetch($, "rest"), n.fetch($, "ret"), n.fetch($, "lastseen"));
                            ...
                            return n.iff($, fn.matches(n.fetch($, "head"), n.string(";")),
                                ...
                                function($) {
                                    return $=n.put($, "next", n.item(n.iff($, fn.empty(n.fetch($, "rest")),
                                        ...
                                        $=n.put($, "rest", n.item(n.iff($, fn.false(),
                                        ...
                                        n.iff($, fn.matches(n.fetch($, "head"), operatorRegexp),
                                            ...
                                            function($) {
console.log(n.string("stop body"));
//return n.stop($,block(n.fetch($,"rest"),n.fetch($,"ret")));
                                                return n.stop($, n.item(bodyOp(opNum(n.fetch($, "head")), n.fetch($, "next"), n.fetch($, "lastseen"), n.fetch($, "rest"), n.fetch($, "ret"))));

                                            },

                                            function($) {
console.log(n.string("continue body"));
//return n.stop($,block(n.fetch($,"rest"),n.fetch($,"ret")));
    ...
    return n.initialize(arguments, [
        ...
        return n.iff($, fn.empty(n.fetch($, "parts")),
            ...
            function($) {
                ...
                return (
                    $=n.put($, "head", n.item(n.select(fn.head(n.fetch($, "parts")), function($_0) {
                           return fn.string($_0);
                       }))),
                $=n.put($, "rest", n.item(fn.tail(n.fetch($, "parts")))),

                $=n.put($, "head", n.item(n.iff($, n.and(n.eq(n.fetch($, "ret"), n.string("")), n.eq(n.fetch($, "head"), n.string("=#20#01="))),
                ...
                n.cont($,n.fetch($, "rest"),fn.concat(n.fetch($, "ret"),n.fetch($, "head"))));
