...
export const operatorsI = fn.foldLeft(map.keys(operators),n.map(),function($pre,$cur) /*n.item()*/ {
...
n.concat("core:",n.get(operatorMap,$opnum)) :

n.concat("core:",fn.replace(n.get(operators,$opnum)," ","-")));
...
return (($arg = n.item(n.get(operators,$key)),
