...
return n.seq(($head = n.item(n.select(n.filter(n.select(fn.head($parts),n.seq("fn:group")),function($_0) { return n.seq(n.geq(n.selectAttribute($_0,"nr"),1));}),function($_0) { return n.seq(fn.string($_0));})),
...
return n.seq(($head = n.item(n.select(fn.head($parts),function($_0) { return n.seq(fn.string($_0));})),
...
return n.seq(($maybeParam = n.item(n.select(fn.head($parts),function($_0) { return n.seq(fn.string($_0));})),
...
return params(fn.tail($parts),n.concat(n.select(n.filter(n.concat($ret,n.select(fn.head($parts),n.seq("fn:group"))),function($_0) { return n.seq(n.geq(n.selectAttribute($_0,"nr"),1));}),function($_0) { return n.seq(fn.string($_0));}),",(),("));
...
return n.seq(($ns = n.item(fn.replace(n.select(fn.head($parts),function($_0) { return n.seq(fn.string($_0));}),"\\s","")),
...
return body(fn.subsequence($parts,3),fn.concat($ret,n.select(n.filter($parts,function($_0) { return n.seq(n.geq(fn.position($_0),1));}),function($_0) { return n.seq(fn.string($_0));}),",(),"),n.seq(n.decimal("2.18")));
...
return n.seq(($maybeAnnot = n.item(n.select(n.filter(n.select(fn.head($parts),n.seq("fn:group")),function($_0) { return n.seq(n.geq(n.selectAttribute($_0,"nr"),1));}),function($_0) { return n.seq(fn.string($_0));})),
...
return block(fn.subsequence($parts,3),fn.concat($ret,"core:xq-version($,",n.select(n.filter($parts,function($_0) { return n.seq(n.geq(fn.position($_0),2));}),function($_0) { return n.seq(fn.string($_0));}),")"));

}

export function xmodule($parts,$ret) {

return block(fn.subsequence($parts,5),fn.concat($ret,"core:module($,",n.select(n.filter($parts,function($_0) { return n.seq(n.geq(fn.position($_0),2));}),function($_0) { return n.seq(fn.string($_0));}),",",n.select(n.filter($parts,function($_0) { return n.seq(n.geq(fn.position($_0),4));}),function($_0) { return n.seq(fn.string($_0));}),",())"));
...
return (n.atomic(n.and(fn.exists($b),n.geq(fn.head($b),n.seq(n.decimal("2.08"),n.decimal("2.11"))))) ?
...
n.filter($id,function($_0) { return n.seq(fn.last($_0));}))));
...
return n.seq(($llast = n.item(n.filter($lastseen,function($_0) { return n.seq(fn.last($_0));})),
...
n.seq($old = n.item($lastseen),$closer = n.item(closer($lastseen)),$lastseen = n.item(fn.subsequence($lastseen,1,n.subtract(fn.count($lastseen),$closer))),$ret = n.item(fn.concat($ret,fn.stringJoin(n.forEach(n.seq(n.to(1,$closer)),")")),(n.atomic(n.eq(n.filter($lastseen,function($_0) { return n.seq(n.subtract(fn.last($_0),1));}),n.decimal("21.07"))) ?
...
0)),$letclose = n.item(n.and(n.and(n.eq($no,n.decimal("2.09")),fn.not(n.or(n.eq($llast,n.decimal("20.06")),fn.empty($lastseen)))),n.geq($hascomma,fn.false()))),$letcloser = n.item((n.atomic(n.and($letclose,n.geq($llast,n.seq(n.decimal("2.08"),n.decimal("2.11"))))) ?
...
fn.concat(fn.stringJoin(n.forEach(n.seq(n.to(1,$letcloser)),")")),(n.atomic(n.eq(n.filter($lastseen,function($_0) { return n.seq(n.subtract(fn.last($_0),$letcloser));}),n.decimal("2.10"))) ?
...
(n.atomic(n.and(n.geq($next,fns),fn.matches(n.filter($rest,function($_0) { return n.seq(n.geq(fn.position($_0),2));}),"\\)"))) ?
...
$lastseen)),$lastseen = n.item((n.atomic(n.eq(n.filter(n.and($letclose,$lastseen),function($_0) { return n.seq(fn.last($_0));}),n.decimal("2.10"))) ?
...
n.seq($lastseen = n.item(fn.subsequence($lastseen,1,n.subtract(lastIndexOf($lastseen,n.decimal("20.06")),1))),(n.atomic(n.and(n.eq(fn.round(n.filter($lastseen,function($_0) { return n.seq(fn.last($_0));})),21),n.ne($next,"=#20#06="))) ?
...
$lastseen)))))))))),$nu = n.item(console.log(n.seq($no," :: ",fn.stringJoin($old,","),"->",fn.stringJoin($lastseen,",")," || ",fn.replace(fn.replace($ret,"=#2#06=","if"),"=#2#09=","let")))),body($rest,$ret,$lastseen))))))));

}

export function isArray($head,$non,$next) {

return n.and(n.and(n.eq($non,n.decimal("20.01")),n.geq(fn.matches($head,"\\)\\s*$"),fn.false())),fn.matches($head,n.concat(n.concat("^(\\s|\\(|,|",operatorRegexp),")")));
...
n.seq($head = n.item(n.select(fn.head($parts),function($_0) { return n.seq(fn.string($_0));})),$rest = n.item(fn.tail($parts)),$lastseen = n.item(parenCloser($head,$lastseen)),(n.atomic(n.geq($head,"=#25#01=")) ?

comment($rest,$ret,$lastseen) :

(n.atomic(fn.matches($head,";")) ?

block($parts,(n.atomic(n.eq(n.filter($lastseen,function($_0) { return n.seq(fn.last($_0));}),n.decimal("2.18"))) ?
...
n.select(fn.head($rest),function($_0) { return n.seq(fn.string($_0));}))),$non = n.item((n.atomic(fn.matches($next,operatorRegexp)) ?
...
block($rest,fn.concat($ret,"core:import($,",n.select(n.filter($parts,function($_0) { return n.seq(n.geq(fn.position($_0),3));}),function($_0) { return n.seq(fn.string($_0));}),",",n.select(n.filter($parts,function($_0) { return n.seq(n.geq(fn.position($_0),5));}),function($_0) { return n.seq(fn.string($_0));}),")")))));
...
n.seq($val = n.item(n.select(fn.head($parts),function($_0) { return n.seq(fn.string($_0));})),$rest = n.item(fn.tail($parts)),(n.atomic(fn.matches($val,operatorRegexp)) ?
...
$x = body($parts,$ret), console.log($x), $x))));
...
n.decimal(operatorsI(n.filter($k,function($_0) { return n.seq(n.geq(fn.position($_0),$i));})))));
...
return n.decimal(fn.replace($op,"^=#(\\p{N}+)#?(\\p{N}*)=$","$1.$2"));
...
n.seq($argsize = n.item(array.size($last("args"))),$nargs = n.item((n.atomic($isUnaryOp) ?

n.array(n.seq()) :

n.filter($last("args"),n.seq(2)))),$nargs = n.item((n.atomic($val) ?
