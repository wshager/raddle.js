...
function as$6(...$_a) {
    ...
    $ = $("next", n.select(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(2))), $_0 => fn.string($_0)));
    $ = $("no", ($ => {
        if ($.test(fn.matches($("head"), operatorRegexp))) {
            return opNum($("head"));
        } else {
...
function xvar$2(...$_a) {
    var $ = n.frame($_a).item("parts").item("ret");
    return body(fn.subsequence($("parts"), n.integer(3)), fn.concat($("ret"), n.select(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(1))), $_0 => fn.string($_0)), n.string(",(),")), n.array(n.seq(n.decimal(2.18))));
}

function xns$2(...$_a) {
    var $ = n.frame($_a).item("parts").item("ret");
    return block(fn.subsequence($("parts"), n.integer(4)), fn.concat($("ret"), n.string("core:namespace($,"), n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(1))), n.string(","), n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(3))), n.string(")")));
}
...
function xversion$2(...$_a) {
    var $ = n.frame($_a).item("parts").item("ret");
    return block(fn.subsequence($("parts"), n.integer(3)), fn.concat($("ret"), n.string("core:xq-version($,"), n.select(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(2))), $_0 => fn.string($_0)), n.string(")")));
}

function xmodule$2(...$_a) {
    var $ = n.frame($_a).item("parts").item("ret");
    return block(fn.subsequence($("parts"), n.integer(5)), fn.concat($("ret"), n.string("core:module($,"), n.select(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(2))), $_0 => fn.string($_0)), n.string(","), n.select(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(4))), $_0 => fn.string($_0)), n.string(",())")));
}
...
function comment$3(...$_a) {
    ...
    $ = $("rest", fn.tail($("parts")));
    return ($ => {
        if ($.test(n.geq($("head"), n.string("=#25#02="))) || n.empty($("rest"))) {
...
function parenCloser$2(...$_a) {
    ...
    return ($ => {
        if ($.test(fn.matches($("head"), n.string("[\\(\\)]+")))) {
            ...
            $ = $("lastseen", fn.foldLeft(n.cxFilter($("cp"), $_0 => n.eq($_0, n.integer(40))), $("lastseen"), function (...$_a) {
                $ = $.frame($_a).item("pre").item("cur");
                return array.append($("pre"), $("cur"));
            }));
            return close($("lastseen"), fn.count(n.cxFilter($("cp"), $_0 => n.eq($_0, n.integer(41)))));
        } else {
            return $("lastseen");
        }
    })($.frame());
...
function ximport$2(...$_a) {
    ...
    return ($ => {
        if ($.test(fn.matches($("maybeAt"), n.string("at")))) {
            return block(fn.subsequence($("rest"), n.integer(3)), fn.concat($("ret"), n.string("core:ximport($,"), n.select(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(3))), $_0 => fn.string($_0)), n.string(","), n.select(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(5))), $_0 => fn.string($_0)), n.string(","), n.select(n.cxFilter($("rest"), $_0 => n.geq(fn.position($_0), n.integer(2))), $_0 => fn.string($_0)), n.string(")")));
        } else {
            return block($("rest"), fn.concat($("ret"), n.string("core:ximport($,"), n.select(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(3))), $_0 => fn.string($_0)), n.string(","), n.select(n.cxFilter($("parts"), $_0 => n.geq(fn.position($_0), n.integer(5))), $_0 => fn.string($_0)), n.string(")")));
        }
    })($.frame());
}
