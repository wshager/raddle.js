...
if($_l==2){
	...
	$.init($.item("pre /* item */"),$.item("arg /* item */"));
...
if($_l==3){
	...
	$.init($.item("pre /* item */"),$.item("arg /* item */"),$.item("at /* item */"));
...
$.item("fname",rdl.camelCase(n.filter($.get("parts"),function($_0) { return n.geq(fn.position($_0),fn.last($_0));}))),
...
if($_l==3){
	...
	$.init($.item("pre /* item */"),$.item("cur /* item */"),$.item("i /* item */"));
...
if($_l==3){
	...
	$.init($.item("pre /* item */"),$.item("cur /* item */"),$.item("at /* item */"));
...
$.test(n.eq(fn.count($.get("parts")),n.integer(1))) ?
 ...
 ($.test(fn.matches(n.filter($.get("parts"),function($_0) { return n.geq(fn.position($_0),n.integer(1));}),fn.concat(n.string("^\\$?"),n.call($.get("frame"),n.string("$prefix"))))) ?

 (fn.replace(n.filter($.get("parts"),function($_0) { return n.geq(fn.position($_0),fn.last($_0));}),n.string("\\$"),n.string(""))) :

 (fn.concat(fn.replace(n.filter($.get("parts"),function($_0) { return n.geq(fn.position($_0),n.integer(1));}),n.string("\\$"),n.string("")),n.string("."),n.filter($.get("parts"),function($_0) { return n.geq(fn.position($_0),n.integer(2));}))))) :
...
$.item("prefix",$.test(n.eq(n.filter($.get("p"),function($_0) { return n.geq(fn.position($_0),n.subtract(fn.last($_0),n.integer(1)));}),$.get("prefix"))) ?

 (n.seq()) :

 ($.test(n.filter($.get("p"),function($_0) { return n.geq(fn.position($_0),n.subtract(fn.last($_0),n.integer(1)));})) ?

 (n.filter($.get("p"),function($_0) { return n.geq(fn.position($_0),n.subtract(fn.last($_0),n.integer(1)));})) :
...
fn.concat(n.string(""),rdl.camelCase($.get("prefix")),$.test($.get("prefix")) ?
 ...
 (n.string("")),rdl.camelCase(n.filter($.get("p"),function($_0) { return n.geq(fn.position($_0),fn.last($_0));})))));
...
$.test(n.call($.get("args"),n.integer(3))) ?
 ...
 (fn.concat(n.string("$"),fn.replace($.get("param"),n.string("^([^\\.]*)(\\.{3})$"),n.string("$2 $1")),n.string(" /* "),n.call($.get("args"),n.integer(1)),n.call($.get("args"),n.integer(4)),n.string(" */"))))));
