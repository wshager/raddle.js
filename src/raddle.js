...
export function parseStrings(...$_a) {
    ...
    if($_l==1){
        $.init($.item("i"));
        return n.item($.test(n.eq(fn.name(n.filter($.get("strings"),function($_0) { return n.geq(fn.position($_0),$.get("i"));})),n.string("match"))) ?

 (n.concat(n.string("$%"),$.get("i"))) :

 (n.select(n.filter($.get("strings"),function($_0) { return n.geq(fn.position($_0),$.get("i"));}),function($_0) { return fn.string($_0);})));
    }
    return n.error($_l);
...
export function getIndexFromTokens(...$_a) {
    ...
    if($_l==1){
        $.init($.item("i"));
        return n.item($.test(n.and(fn.exists(n.filter(fn.indexOf($.get("tok"),n.minus(n.integer(1))),function($_0) { return n.geq(fn.position($_0),$.get("i"));})),n.filter(n.glt(n.filter(fn.indexOf($.get("tok"),n.minus(n.integer(1))),function($_0) { return n.geq(fn.position($_0),$.get("i"));}),fn.indexOf($.get("tok"),n.integer(1))),function($_0) { return n.geq(fn.position($_0),$.get("i"));}))) ?

 (n.seq()) :

 (n.add(n.filter(fn.indexOf($.get("tok"),n.integer(1)),function($_0) { return n.geq(fn.position($_0),$.get("i"));}),n.integer(1))));
    }
    return n.error($_l);
});
    }
...
export function getIndex(...$_a) {
    ...
    if($_l==1){
        $.init($.item("_"));
        return ($.item("_",n.selectAttribute(n.filter(n.select($.get("_"),n.seq(n.string("fn:group"))),function($_0) { return n.select($_0,n.seq(n.text()));}),n.string("nr"))),
...
n.item($.test(n.geq($.get("_"),n.integer(1))) ?
 ...
 (n.integer(0)))));
    ...
    return n.error($_l);
})),function($_0) { return n.geq(fn.position($_0),n.integer(1));});
    }
...
export function appendOrNest(...$_a) {
    ...
    if($_l==5){
        ...
        return ($.item("x",$.test(n.filter($.get("group"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("nr")),n.integer(3));})) ?

 (n.map(n.seq(n.pair(n.string("name"),valueFromStrings(n.select(n.filter($.get("group"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("nr")),n.integer(3));}),function($_0) { return fn.string($_0);}),$.get("strings"))),n.pair(n.string("args"),wrap($.get("next"),$.get("strings"))),n.pair(n.string("suffix"),$.get("suffix"))))) :

 (wrap($.get("next"),$.get("strings")))),

n.item($.test(fn.matches(n.select(n.filter($.get("group"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("nr")),n.integer(2));}),function($_0) { return fn.string($_0);}),n.concat(n.concat(n.string("^"),xqc.operatorRegexp),n.string("$")))) ?

 ($.item("operator",n.select(n.filter($.get("group"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("nr")),n.integer(2));}),function($_0) { return fn.string($_0);})),
...
$.test(fn.empty($.get("last"))) ?
 ...
 ($.item("hasPrecedingOp",n.and(n.instanceOf($.get("last"),Map),fn.matches(n.call($.get("last"),n.string("name")),xqc.operatorRegexp))),
...
export function wrap(...$_a) {
    ...
    if($_l==4){
        ...
        return $.test(fn.exists($.get("rest"))) ?

 ($.test(n.and(n.filter($.get("group"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("nr")),n.integer(4));}),n.select($.get("group"),n.seq(n.text())))) ?

 (wrapOpenParen($.get("rest"),$.get("strings"),getIndex($.get("rest")),$.get("group"),$.get("ret"))) :

 ($.test(n.or(n.filter($.get("group"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("nr")),n.integer(3));}),fn.matches(n.select(n.filter($.get("group"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("nr")),n.integer(2));}),function($_0) { return fn.string($_0);}),n.concat(xqc.operatorRegexp,n.string("+|,"))))) ?

 (wrap($.get("rest"),$.get("strings"),appendPropOrValue(n.select(n.filter($.get("group"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("nr")),n.integer(3));}),function($_0) { return fn.string($_0);}),n.select(n.filter($.get("group"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("nr")),n.integer(2));}),function($_0) { return fn.string($_0);}),$.get("strings"),$.get("ret")))) :
 ...
 ($.get("ret"));
    ...
    if($_l==2){
        ...
        return xqc.rename(wrap($.get("match"),$.get("strings"),n.array(n.seq())),function(...$_a){
    var $_l = $_a.length;
    $ = n.frame($,$_a);
    if($_l==1){
        $.init($.item("name"));
...
$.item("location",n.anyURI(n.selectAttribute(n.filter($.get("map"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("name")),$.get("name"));}),n.string("location")))),

$.item("uri",n.anyURI(n.selectAttribute(n.filter($.get("map"),function($_0) { return n.geq(n.selectAttribute($_0,n.string("name")),$.get("name"));}),n.string("uri")))),
...
a.foldLeftAt($.get("a"),n.string(""),function(...$_a){
    var $_l = $_a.length;
    $ = n.frame($,$_a);
    if($_l==3){
        $.init($.item("acc"),$.item("t"),$.item("i"));
        return ($.item("type",$.test(n.instanceOf($.get("t"),Map)) ?
...
n.eval(parse($.get("query"),$.get("params"))),
