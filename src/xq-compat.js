...
export function normalizeQuery(...$_a) {
    ...
    if ($_l == 2) {
        ...
        return ($.item("query", fn.replace(fn.replace(fn.replace(fn.replace($.get("query"), n.string("%3E"), n.string(">")), n.string("%3C"), n.string("<")), n.string("%2C"), n.string(",")), n.string("%3A"), n.string(":"))),
            ...
            $.item("query", fn.foldLeft(n.filter(map.keys(operators), function($_0) {
            ...
            $.item("query", fn.stringJoin(fn.forEach(fn.tokenize($.get("query"), n.string(";")), function(...$_a) {
                var $_l = $_a.length;
                $ = n.frame($, $_a);
                if ($_l == 1) {
                    $.init($.item("cur"));
    ...
    if ($_l == 3) {
        ...
        return ($.item("head", n.select(n.filter(n.select(fn.head($.get("parts")), n.seq(n.string("fn:group"))), function($_0) {
            ...
            $.item("maybeSeqtype", $.test(fn.matches($.get("head"), operatorRegexp)) ?
                (opNum($.get("head"))) :
                (n.integer(0))),
            n.item($.test(n.eq($.get("maybeSeqtype"), n.decimal(20.06))) ?
    ...
    if ($_l == 6) {
        ...
        return ($.item("head", n.select(fn.head($.get("parts")), function($_0) {
            ...
            $.item("non", $.test(fn.matches($.get("next"), operatorRegexp)) ?
                (opNum($.get("next"))) :
                (n.integer(0))),
            n.item($.test(n.eq($.get("no"), n.decimal(20.06))) ?
                    ...
                    ($.test(n.eq($.get("no"), n.integer(1))) ?
                        ...
                        ($.test(fn.matches($.get("head"), fn.concat(n.string("core:["), ncname, n.string("]+")))) ?
                            ($.test(fn.matches($.get("next"), n.string("^\\s*\\(\\s*$"))) ?
                                (as(n.seq(), fn.subsequence($.get("parts"), n.integer(3)), fn.concat($.get("ret"), $.get("head"), n.string("("), $.get("param"), n.string(","), $.test(n.eq($.get("head"), n.string("core:anon"))) ?
                                    (n.string("(")) :
                                    (n.string(""))), $.get("lastseen"), fn.true(), $.get("seqtype"))) :
                                (as(n.seq(), fn.tail($.get("parts")), fn.concat($.get("ret"), $.get("head"), n.string("("), $.get("param"), $.test(n.eq($.get("head"), n.string("core:anon"))) ?
                                    (n.string(",(")) :
                                    ...
                                    ($.test(n.and($.get("subtype"), n.geq($.get("non"), n.seq(n.integer(1), n.integer(24))))) ?
                                        ...
                                        ($.test(n.eq($.get("non"), n.integer(24))) ?
                                            ...
                                            ($.test(n.eq($.get("non"), n.decimal(20.06))) ?
                                                ...
                                                (console.log(n.seq(n.string("what"), $.get("parts"))))))) :
...
export function params(...$_a) {
    ...
    if ($_l == 3) {
        ...
        return ($.item("maybeParam", n.select(fn.head($.get("parts")), function($_0) {
            ...
            n.item($.test(fn.matches($.get("maybeParam"), n.string("^\\(?\\s*\\)"))) ?
...
export function annot(...$_a) {
    ...
    if ($_l == 3) {
        ...
        return ($.item("maybeAnnot", n.select(n.filter(n.select(fn.head($.get("parts")), n.seq(n.string("fn:group"))), function($_0) {
            ...
            $.item("rest", fn.tail($.get("parts"))),
            n.item($.test(fn.matches($.get("maybeAnnot"), n.string("^%"))) ?
                ...
                ($.test(n.geq($.get("maybeAnnot"), n.string("namespace"))) ?
                    ...
                    ($.test(n.geq($.get("maybeAnnot"), n.string("=#21#06="))) ?
                        ...
                        ($.test(n.geq($.get("maybeAnnot"), n.string("=#2#18="))) ?
                            (xvar($.get("rest"), fn.concat($.get("ret"), n.string("core:xvar"), $.get("annot"), n.string("($,")))) :
                            ($.get("ret")))))));
    }
...
export function close(...$_a) {
    ...
    if ($_l == 3) {
        ...
        return n.item($.test(n.or(fn.empty($.get("lastseen")), n.eq($.get("no"), n.integer(0)))) ?
...
export function closer(...$_a) {
    ...
    if ($_l == 2) {
        ...
        return n.item($.test(n.and(fn.exists($.get("b")), n.geq(fn.head($.get("b")), n.seq(n.decimal(2.08), n.decimal(2.11))))) ?
...
export function comment(...$_a) {
    ...
    if ($_l == 3) {
        ...
        return ($.item("head", n.select(fn.head($.get("parts")), function($_0) {
            ...
            $.item("rest", fn.tail($.get("parts"))),
            n.item($.test(n.geq($.get("head"), n.string("=#25#02="))) ?
    ...
    if ($_l == 5) {
        ...
        return ($.item("llast", n.filter($.get("lastseen"), function($_0) {
            ...
            $.item("lastseen", $.test(n.eq($.get("llast"), n.decimal(19.01))) ?
                (pop($.get("lastseen"))) :
                ($.get("lastseen"))),
            n.item($.test(n.eq($.get("no"), n.integer(1))) ?
                ($.item("old", $.get("lastseen")),
                    ...
                    $.item("ret", fn.concat($.get("ret"), fn.stringJoin(n.forEach(n.seq(n.to(n.integer(1), $.get("closer"))), n.string(")"))), $.test(n.eq(n.filter($.get("lastseen"), function($_0) {
                    ...
                    ($.test(n.eq($.get("no"), n.decimal(21.06))) ?
                        ...
                        ($.test(n.eq(fn.round($.get("no")), n.integer(21))) ?
                            ...
                            ($.item("old", $.get("lastseen")),
                                ...
                                $.item("llast", n.filter($.get("lastseen"), function($_0) {
                                    return n.geq(fn.position($_0), fn.last($_0));
                                })),
                                ...
                                $.item("positional", n.and(n.and(n.eq($.get("no"), n.decimal(20.01)), $.get("next")), n.seq(n.or(n.seq(n.and(fn.matches($.get("next"), n.concat(n.concat(n.string("^([\\+\\-]?(\\p{N}+))$|^\\$["), ncname), n.string("]+$"))), n.eq(n.filter($.get("rest"), function($_0) {
                                    return n.geq(fn.position($_0), n.integer(2));
                                }), n.string("=#20#02=")))), fn.matches($.get("next"), n.string("(fn:)?last")))))),
                                ...
                                $.item("ret", fn.concat($.get("ret"), $.test(n.geq($.get("no"), n.seq(n.decimal(2.06), n.decimal(2.09), n.decimal(20.01), n.decimal(20.04)))) ?
                                    (fn.concat($.test($.get("letclose")) ?
                                        (fn.concat(fn.stringJoin(n.forEach(n.seq(n.to(n.integer(1), $.get("letcloser"))), n.string(")"))), $.test(n.eq(n.filter($.get("lastseen"), function($_0) {
                                        ...
                                        ($.test(n.eq($.get("no"), n.decimal(20.01))) ?
                                            (fn.concat($.test(fn.matches($.get("next"), n.string("#20#08"))) ?
                                                ...
                                                ($.test($.get("positional")) ?
                                                    ...
                                                    (n.string(""))), $.get("next"))) :
                                            (n.string(""))))) :
                                    ($.test(n.or(n.eq($.get("no"), n.integer(26)), n.seq(n.and(n.eq($.get("no"), n.decimal(2.10)), n.eq(n.filter($.get("lastseen"), function($_0) {
                                            return n.geq(fn.position($_0), n.subtract(fn.last($_0), n.integer(1)));
                                        }), n.decimal(21.07)))))) ?
                                        (n.string(",")) :
                                        ($.test(n.eq($.get("no"), n.decimal(20.07))) ?
                                            ($.item("lastindex", lastIndexOf($.get("lastseen"), n.decimal(20.06))),
                                                ...
                                                $.item("closes", n.filter(fn.subsequence($.get("lastseen"), $.get("lastindex"), fn.count($.get("lastseen"))), function($_0) {
                                ...
                                $.item("rest", $.test(n.or(fn.empty($.get("rest")), fn.not(n.geq($.get("no"), n.seq(n.decimal(2.09), n.decimal(20.01)))))) ?
                                    ($.get("rest")) :
                                    ($.test(n.and(n.geq($.get("next"), fns), fn.matches(n.filter($.get("rest"), function($_0) {
                                            return n.geq(fn.position($_0), n.integer(2));
                                        }), n.string("\\)")))) ?
                                ...
                                $.item("lastseen", $.test(n.geq($.get("no"), n.seq(n.decimal(2.06), n.decimal(2.09), n.decimal(20.01), n.decimal(20.04)))) ?
                                    ($.item("lastseen", $.test($.get("letclose")) ?
                                        ...
                                        $.item("lastseen", $.test(n.and($.get("letclose"), n.eq(n.filter($.get("lastseen"), function($_0) {
                                                return n.geq(fn.position($_0), fn.last($_0));
                                            }), n.decimal(2.10)))) ?
                                            (pop($.get("lastseen"))) :
                                            ($.get("lastseen"))),
                                    ...
                                    ($.test(n.or(n.eq($.get("no"), n.integer(26)), n.seq(n.and(n.eq($.get("no"), n.decimal(2.10)), n.eq(n.filter($.get("lastseen"), function($_0) {
                                        ...
                                        ($.test(n.geq($.get("no"), n.decimal(20.07))) ?
                                            ($.item("lastseen", fn.subsequence($.get("lastseen"), n.integer(1), n.subtract(lastIndexOf($.get("lastseen"), n.decimal(20.06)), n.integer(1)))),
                                                ...
                                                $.test(n.and(n.eq(fn.round(n.filter($.get("lastseen"), function($_0) {
                                                    return n.geq(fn.position($_0), fn.last($_0));
                                                })), n.integer(21)), n.eq($.get("next"), n.string("=#20#06=")))) ?
                                                ($.get("lastseen")) :
                                                (pop($.get("lastseen")))) :
                                            ($.test(n.geq($.get("no"), n.seq(n.decimal(2.07), n.decimal(2.10)))) ?
                                                ($.item("lastseen", $.test(n.or(n.eq($.get("llast"), n.decimal(2.11)), n.seq(n.and(n.eq($.get("no"), n.decimal(2.07)), n.eq($.get("llast"), n.decimal(0.01)))))) ?
                                                    ...
                                                    $.item("last", n.filter(fn.indexOf($.get("lastseen"), n.subtract($.get("no"), n.decimal(n.decimal(0.01)))), function($_0) {
                                                        return n.geq(fn.position($_0), fn.last($_0));
                                                    })),
    ...
    if ($_l == 2) {
        ...
        return n.item($.test(fn.matches($.get("head"), n.string("[\\(\\)]+"))) ?
            ($.item("cp", fn.stringToCodepoints($.get("head"))),
                ...
                $.item("lastseen", n.seq($.get("lastseen"), n.forEach(n.filter($.get("cp"), function($_0) {
                    return n.eq($_0, n.integer(40));
                }), n.decimal(0.01)))),

                close(fn.reverse($.get("lastseen")), fn.count(n.filter($.get("cp"), function($_0) {
...
export function body(...$_a) {
    ...
    if ($_l == 3) {
        $.init($.item("parts"), $.item("ret"), $.item("lastseen"));
        return n.item($.test(fn.empty($.get("parts"))) ?
            (fn.concat($.get("ret"), fn.stringJoin(n.forEach(n.filter($.get("lastseen"), function($_0) {
                return n.geq($_0, n.seq(n.decimal(2.08), n.decimal(2.11), n.decimal(20.07), n.decimal(2.18)));
            }), n.string(")"))))) :
            ($.item("head", n.select(fn.head($.get("parts")), function($_0) {
                    return fn.string($_0);
                })),
                ...
                ($.test(fn.matches($.get("head"), n.string(";"))) ?
                    ...
                    ($.item("next", $.test(fn.empty($.get("rest"))) ?
                            (n.seq()) :
                            (n.select(fn.head($.get("rest")), function($_0) {
                                return fn.string($_0);
                            }))),
                        ...
                        $.item("head", $.test(n.and(n.eq($.get("head"), n.string("=#20#01=")), n.geq($.get("ret"), n.string("")))) ?
                            (n.string("=#20#04=")) :
                            ($.get("head"))),
...
export function ximport(...$_a) {
    ...
    if ($_l == 2) {
        ...
        return ($.item("rest", fn.subsequence($.get("parts"), n.integer(6))),
            $.item("maybeAt", n.select(fn.head($.get("rest")), function($_0) {
                return fn.string($_0);
            })),
            n.item($.test(fn.matches($.get("maybeAt"), n.string("at"))) ?
                (block(fn.subsequence($.get("rest"), n.integer(3)), fn.concat($.get("ret"), n.string("core:ximport($,"), n.select(n.filter($.get("parts"), function($_0) {
                    return n.geq(fn.position($_0), n.integer(3));
                }), function($_0) {
                    return fn.string($_0);
                }), n.string(","), n.select(n.filter($.get("parts"), function($_0) {
                ...
                (block($.get("rest"), fn.concat($.get("ret"), n.string("core:ximport($,"), n.select(n.filter($.get("parts"), function($_0) {
                    return n.geq(fn.position($_0), n.integer(3));
                }), function($_0) {
                    return fn.string($_0);
                }), n.string(","), n.select(n.filter($.get("parts"), function($_0) {
...
export function block(...$_a) {
    ...
    if ($_l == 2) {
        ...
        return n.item($.test(fn.empty($.get("parts"))) ?
            ($.get("ret")) :
            ($.item("val", n.select(fn.head($.get("parts")), function($_0) {
                    return fn.string($_0);
                })),
...
export function fromOp(...$_a) {
    ...
    if ($_l == 1) {
        ...
        return ($.item("k", map.keys(operatorsI)),
            $.item("i", n.filter(fn.indexOf($.get("k"), fn.replace($.get("op"), n.string("^core:"), n.string(""))), function($_0) {
                return n.geq(fn.position($_0), n.integer(1));
            })),
...
export function rename(...$_a) {
    ...
    if ($_l == 2) {
        ...
        return array.forEach($.get("a"), function(...$_a) {
            ...
            if ($_l == 1) {
                $.init($.item("t"));
                return n.item($.test(n.instanceOf($.get("t"), n.map())) ?
        ...
        return ($.item("arg", n.call(operators, $.get("key"))),
            ...
            n.string($.test(fn.matches($.get("arg"), n.string("\\p{L}+"))) ?
                ...
                ($.item("arg", fn.replace($.get("arg"), n.string("(\\.|\\[|\\]|\\\\|\\||\\-|\\^|\\$|\\?|\\*|\\+|\\{|\\}|\\(|\\))"), n.string("\\\\$1"))),
                    ...
                    (n.concat(n.concat(n.string("(\\s?)"), $.get("arg")), n.string("(\\s*[^\\p{L}_])"))) :
...
export function operatorPrecedence(...$_a) {
    var $_l = $_a.length,
        $ = n.frame($_a);
    ...
    if ($_l == 3) {
        ...
        return ($.item("rev", array.reverse($.get("ret"))),
            ...
            $.item("hasPrecedingOp", n.and(n.instanceOf($.get("last"), n.map()), fn.matches(n.call($.get("last"), n.string("name")), operatorRegexp))),
            ...
            $.item("args", $.test($.get("preceeds")) ?
                (function($_0) {
                    return $.item("argsize", array.size(n.call($.get("last"), n.string("args")))),
