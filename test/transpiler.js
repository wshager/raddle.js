define(function (require) {
	...
	add("use(core/numeric-arithmetic-operators,core/higher-order-functions),define(sum,(any*,any*),(),fold-left(0,add#1)),local:sum()",function (error, fn) {
		var val = [];
		for(var i=0;i<10;i++){
			val.push(i);
		}
	...
	add("use(core/numeric-arithmetic-operators,core/numeric-comparison-operators,core/higher-order-functions,core/list-functions,core/map-functions,core/string-value-functions),define(appender,(map,map),((any*),(any*)),map-transform(?,(append(?)))),unfold((tail()),(empty()),(head()),local:appender#2,(head(),string-length()))",function (error, fn) {
